...
The current phase focuses on building, learning and GDPR-compliant
infrastructure. There is **no SLA**, no guaranteed data freshness and no
automatic failover. Once enough sources are live and the platform is stable,
we'll migrate to a true production environment.
